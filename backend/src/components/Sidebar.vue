<template>
  <div class="min-w-[200px] w-[200px]  transition-all bg-indigo-700 text-white py-4 px-2">
...
<script setup>
  import {HomeIcon, PhotographIcon, UserGroupIcon, UsersIcon, ViewListIcon, ChartBarIcon} from '@heroicons/vue/outline'
</script>
